  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        if (cancelled) return
        setStatus('err')
        setMessage(e instanceof ApiError ? e.message : 'Could not complete link.')
      }
    })()
    ...
    return (
      <div className="oauth-callback-page">
        <div className="oauth-callback-card">
          ...
          <p className="oauth-callback-msg oauth-callback-err">{blockingError}</p>
          <button
            type="button"
  ...
  return (
    <div className="oauth-callback-page">
      <div className="oauth-callback-card">
        ...
        {status === 'working' ? <div className="oauth-callback-spinner" /> : null}
